...
MATCH_SERVICE_URL = "http://match_service:5004"
TOURNAMENT_SERVICE_URL = "http://tournament_service:5002"
...
def finalize_outcome():
    ...
    patch_res = requests.put(f"{TOURNAMENT_SERVICE_URL}/tournament/{tournament_id}", json=patch_payload)
